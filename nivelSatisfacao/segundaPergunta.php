...
<body>
    ...
    <div class="container">
            <h3 class="text-center mt-5">2 - Como voce avalia os nossos <b>Serviços?</b></h3>
        
        <hr>
        
        <div class="row ">
            <div class="col-md-3 col-sm-3">
                <a href="inserirEscolha.php?voto=<?php echo 5 ?>">
            ...
            <div class="col-md-3 col-sm-3">
                <a href="inserirEscolha.php?voto=<?php echo 6 ?>">
            ...
            <div class="col-md-3 col-sm-3">
                <a href="inserirEscolha.php?voto=<?php echo 7 ?>">
            ...
            <div class="col-md-3 col-sm-3">
                <a href="inserirEscolha.php?voto=<?php echo 8 ?>">
